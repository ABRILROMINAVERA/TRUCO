...
Esta copia usa la extension '.pyw' para que Windows la ejecute con
pythonw.exe (subsistema grafico) en lugar de python.exe (subsistema de
consola): al abrirla con doble clic no aparece ninguna ventana de terminal,
solo la interfaz grafica. Todo el texto del juego se ve en el historial de
la propia ventana, no en una consola.
